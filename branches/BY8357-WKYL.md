...
- 有效端差异文件：390 个；涉及功能域：首页/导航/版面、主题/颜色/静态资源、接口/状态/工具、彩票/投注/开奖、未归类路径、个人中心/账户、登录/注册/验证码、构建/配置。
- 其他路径差异文件：2 个；通常是根配置、文档或非端目录，需要按完整清单核对。
- 扫描到新增/变更颜色值：#fff, #ffffff, #0000, #e4393c, #000000, #f3f3f3, #000, #333, #eee, #313131, #1f6efe, #ddc17c, #999, #eeeeee, #be1204, #ab47bc, #131522, #dddee1, #3be6e5, #1f94ff。
...
| --- | --- | --- | --- | --- |
| pc | 350 | 100825 | 57804 | pc/.gitignore<br>pc/README.md<br>pc/build/webpack.dev.conf.js<br>pc/config/index.js<br>pc/configstatic/pc/control/control.js<br>pc/configstatic/pc/images/Icon-60.png<br>pc/configstatic/pc/images/favicon.ico<br>pc/configstatic/pc/images/ic_promotion_logo.png<br>...另 342 个路径见完整清单 |
| h5-v2 | 40 | 1576 | 203 | h5-v2/package.json<br>h5-v2/public/configstatic/h5/control/control.js<br>h5-v2/public/index.html<br>h5-v2/src/components/YiDun/index.vue<br>h5-v2/src/main.js<br>h5-v2/src/mixins/initGtCapthca.js<br>h5-v2/src/store/modules/lottey.js<br>h5-v2/src/store/modules/sysDict.js<br>...另 32 个路径见完整清单 |
...
| 功能域 | 文件数 | 涉及端 | 代表路径 |
| --- | --- | --- | --- |
| 首页/导航/版面 | 108 | h5-v2、pc | h5-v2/public/index.html<br>h5-v2/src/components/YiDun/index.vue<br>h5-v2/src/views/free-play/index.vue<br>h5-v2/src/views/password/indexNew.vue<br>h5-v2/src/views7/home/headLine.vue<br>h5-v2/src/views9/home/header.vue<br>pc/config/index.js<br>pc/index.html<br>...另 100 个路径见完整清单 |
| 主题/颜色/静态资源 | 93 | h5-v2、pc | h5-v2/public/configstatic/h5/control/control.js<br>h5-v2/src/store/modules/theme.js<br>h5-v2/src/utils/less.js<br>pc/configstatic/pc/control/control.js<br>pc/configstatic/pc/images/Icon-60.png<br>pc/configstatic/pc/images/favicon.ico<br>pc/configstatic/pc/images/ic_promotion_logo.png<br>pc/configstatic/pc/images/logo-icon.png<br>...另 85 个路径见完整清单 |
| 接口/状态/工具 | 53 | h5-v2、pc | h5-v2/src/mixins/initGtCapthca.js<br>h5-v2/src/store/modules/lottey.js<br>h5-v2/src/store/modules/sysDict.js<br>h5-v2/src/store/modules/theme.js<br>h5-v2/src/utils/aliyunCaptcha.js<br>h5-v2/src/utils/customerService.js<br>h5-v2/src/utils/getSysConfig.js<br>h5-v2/src/utils/less.js<br>...另 45 个路径见完整清单 |
| 彩票/投注/开奖 | 46 | h5-v2、pc | h5-v2/src/views/buy-lottery/buy_lottery.vue<br>pc/src/api/betShare.js<br>pc/src/store/modules/betShare.js<br>pc/src/store/modules/lottery.js<br>pc/src/views-v10/game/components/GameBall.vue<br>pc/src/views-v11/home/fast_betting.vue<br>pc/src/views-v11/layout/child_modal/left_lottery.vue<br>pc/src/views-v11/layout/child_modal/lottery_head.vue<br>...另 38 个路径见完整清单 |
| 未归类路径 | 45 | h5-v2、pc、其他 | .gitignore<br>docs/merchant-frontend-branches.md<br>h5-v2/src/main.js<br>pc/.gitignore<br>pc/README.md<br>pc/package-lock.json<br>pc/src/App.vue<br>pc/src/components/JettonBox.vue<br>...另 37 个路径见完整清单 |
| 个人中心/账户 | 43 | h5-v2、pc | h5-v2/src/views/personal-center/child_modal/agency_center/userAdd.vue<br>h5-v2/src/views/personal-center/child_modal/mysetting/myPhone/myPhone.vue<br>h5-v2/src/views/personal-center/child_modal/mysetting/reset_login_pwd/reset_login_pwd.vue<br>h5-v2/src/views/personal-center/child_modal/personal_info/bindAccountList/baseInfoList.vue<br>h5-v2/src/views/personal-center/child_modal/personal_info/personal_base_info.vue<br>h5-v2/src/views/personal-center/child_modal/takefee_list/aliPay.vue<br>h5-v2/src/views/personal-center/child_modal/takefee_list/weChatPay.vue<br>pc/src/api/user.js<br>...另 35 个路径见完整清单 |
| 登录/注册/验证码 | 40 | h5-v2、pc | h5-v2/src/utils/aliyunCaptcha.js<br>h5-v2/src/utils/loginPasswordRule.js<br>h5-v2/src/views/login/loginMixin.js<br>h5-v2/src/views/password/indexNew.vue<br>h5-v2/src/views/personal-center/child_modal/mysetting/reset_login_pwd/reset_login_pwd.vue<br>h5-v2/src/views/register/registerMixin.js<br>pc/src/assets/images-v11/loginBg.png<br>pc/src/components/login_dlg.vue<br>...另 32 个路径见完整清单 |
| 构建/配置 | 27 | h5-v2、pc | h5-v2/package.json<br>h5-v2/public/configstatic/h5/control/control.js<br>h5-v2/src/utils/getSysConfig.js<br>h5-v2/vue.config.js<br>pc/build/webpack.dev.conf.js<br>pc/config/index.js<br>pc/configstatic/pc/control/control.js<br>pc/configstatic/pc/images/Icon-60.png<br>...另 19 个路径见完整清单 |
...
| 客服/反馈/帮助 | 5 | h5-v2、pc | h5-v2/src/utils/customerService.js<br>pc/src/components/Longqueue/long-helper/longHelperList.vue<br>pc/src/components/Longqueue/long-helper/longRecordList.vue<br>pc/src/utils/customerService.js<br>pc/src/views/feedbackActive/feedbackActive.vue |
...
- 颜色值：#fff, #ffffff, #0000, #e4393c, #000000, #f3f3f3, #000, #333, #eee, #313131, #1f6efe, #ddc17c, #999, #eeeeee, #be1204, #ab47bc, #131522, #dddee1, #3be6e5, #1f94ff, #5169de, #666, #aa8743, #949494, #ec0022, #ff464b, #333333, #ebf2fb, #f5f3a9, #b79954
...
| --- | --- | --- | --- | --- | --- |
| origin/BY-Demo-H5V2-PC | 390 | 0 | 392 | e01faf3edf3d | 2026-04-07 14:20:04 +0900 |
| origin/BY-Demo | 943 | 0 | 945 | e7bcc7ad0a61 | 2023-12-12 17:15:34 +0800 |
| origin/master | 4193 | 3 | 4199 | b7335bc10372 | 2020-08-03 10:12:19 +0800 |

## 最近商户分支提交

| 提交 | 日期 | 说明 |
| --- | --- | --- |
| 016d9502a | 2026-06-19 | fix: remove auth text backgrounds on gold layout |
| f0d451eab | 2026-06-19 | fix: keep active tabs gradient fixed |
| 7f59a9185 | 2026-06-14 | fix: sync h5 theme variables |
| bd30a1385 | 2026-06-12 | fix: limit customer service picker to service links |
| 98c93ab79 | 2026-05-29 | fix: use multUrl for customer service picker |
| 1c29aeec6 | 2026-05-29 | feat: support multiple customer service urls |
| ecb03de9d | 2026-06-11 | fix: localize aliyun captcha trigger text |
| 360a1dc65 | 2026-06-06 | fix: reset pc aliyun captcha lifecycle |
| 76db534ee | 2026-06-05 | fix: align h5 sass loader config |
| 27887df9d | 2026-06-05 | fix: handle aliyun captcha close in h5 requests |
| 4badca83e | 2026-06-05 | fix: release aliyun captcha state after h5 close |
| 1b89be86d | 2026-06-05 | fix: preserve aliyun captcha close lifecycle |
| 918ff0881 | 2026-06-05 | fix: allow h5 aliyun captcha reopen after close |
| e246ea34d | 2026-06-05 | fix: stabilize h5 aliyun captcha touch handling |
| 7b5c71d25 | 2026-06-05 | fix: improve h5 aliyun captcha popup recovery |
| c05952812 | 2026-06-05 | fix: enforce aliyun captcha toggle fallback |
| 053913f27 | 2026-06-05 | fix: keep legacy sms flow when aliyun captcha is off |
| dc0d478e7 | 2026-06-04 | fix: align free play captcha flow with aliyun |
| 509e30b96 | 2026-06-04 | fix: continue login after aliyun popup success |
| 762b4e57c | 2026-06-04 | fix: guard all auth captcha requests |
| 77242cdf0 | 2026-06-04 | feat: replace yidun captcha with aliyun captcha |
| 3244a3ecb | 2026-06-04 | feat: enforce strong login password rules |
| f998e6cec | 2026-04-28 | fix(chat): 进入聊天室时收敛 queryLotteryRecordList 并发（H5 仅当前轮播项倒计时 + Vuex 合并同彩种请求） |
| aedb852d3 | 2026-04-21 | feat: 完成调整8357默认版面 |
...
| M | h5-v2 | 状态 | 主题/颜色/静态资源、接口/状态/工具 | 61 | 57 |  | h5-v2/src/store/modules/theme.js |
...
| M | h5-v2 | 工具/混入 | 主题/颜色/静态资源、接口/状态/工具 | 139 | 46 |  | h5-v2/src/utils/less.js |
...
| M | h5-v2 | 构建配置 | 构建/配置 | 1 | 3 |  | h5-v2/vue.config.js |
...
| M | pc | 组件 | 未归类路径 | 404 | 353 |  | pc/src/components/tryPlay.vue |
...
| M | pc | 工具/混入 | 登录/注册/验证码、接口/状态/工具 | 236 | 76 |  | pc/src/mixins/register.js |
...
| A | pc | 页面 | 登录/注册/验证码、接口/状态/工具 | 647 | 0 |  | pc/src/views-v11/register/registerMixin.js |
...
| M | pc | 页面 | 登录/注册/验证码 | 273 | 206 |  | pc/src/views-v3/content/register/register.vue |
...
| M | pc | 页面 | 登录/注册/验证码 | 98 | 98 |  | pc/src/views-v5/register/register.vue |
...
| M | pc | 页面 | 个人中心/账户 | 804 | 695 |  | pc/src/views/personalCenter/child_modal/userManage/userManage.vue |
...
| M | pc | 页面 | 未归类路径 | 169 | 110 |  | pc/src/views/phoneValid/phoneValid.vue |
...
| M | pc | 页面 | 登录/注册/验证码、接口/状态/工具 | 607 | 491 |  | pc/src/views/register/registerMixin.js |
...
- 分支：`origin/BY8357-WKYL`
- 基准：`origin/BY-Demo-H5V2-PC`
- 完整命令：`git diff --name-status --find-renames origin/BY-Demo-H5V2-PC...origin/BY8357-WKYL -- .`
- 有效端：`pc/`、`h5-v2/`
- 废弃端：`h5/`
