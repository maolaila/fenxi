...
- 来源：远端分支 `origin/BY8358-HP`
- 分支提交：`ca31b2dc7` / 2026-06-19 16:11:08 +0900 / fix: remove auth text backgrounds on gold layout
...
- 有效端差异文件：1095 个；涉及功能域：首页/导航/版面、彩票/投注/开奖、个人中心/账户、接口/状态/工具、未归类路径、聊天室/私聊、主题/颜色/静态资源、资金/充值/提现。
- 其他路径差异文件：2 个；通常是根配置、文档或非端目录，需要按完整清单核对。
- 扫描到新增/变更颜色值：#fff, #ffffff, #0000, #e4393c, #000000, #000, #333, #f3f3f3, #eee, #313131, #1f6efe, #999, #ddc17c, #eeeeee, #be1204, #ab47bc, #ff464b, #131522, #dddee1, #d2b79c。
...
| --- | --- | --- | --- | --- |
| pc | 351 | 101934 | 58878 | pc/.gitignore<br>pc/README.md<br>pc/build/webpack.dev.conf.js<br>pc/config/index.js<br>pc/configstatic/pc/control/control.js<br>pc/configstatic/pc/images/Icon-60.png<br>pc/configstatic/pc/images/favicon.ico<br>pc/configstatic/pc/images/ic_promotion_logo.png<br>...另 343 个路径见完整清单 |
| h5-v2 | 744 | 40747 | 32869 | h5-v2/package.json<br>h5-v2/public/configstatic/h5/control/control.js<br>h5-v2/public/index.html<br>h5-v2/src/App.vue<br>h5-v2/src/api/agent.js<br>h5-v2/src/api/app.js<br>h5-v2/src/api/betting.js<br>h5-v2/src/api/chat.js<br>...另 736 个路径见完整清单 |
...
| 功能域 | 文件数 | 涉及端 | 代表路径 |
| --- | --- | --- | --- |
| 首页/导航/版面 | 325 | h5-v2、pc | h5-v2/public/index.html<br>h5-v2/src/api/home.js<br>h5-v2/src/assets/images/home/licai.png<br>h5-v2/src/components/CollectGrid/index.vue<br>h5-v2/src/components/CountDown/index.vue<br>h5-v2/src/components/EmptyData/index.vue<br>h5-v2/src/components/FollowOrder/index.vue<br>h5-v2/src/components/FundPassPopup/index.vue<br>...另 317 个路径见完整清单 |
...
| 个人中心/账户 | 160 | h5-v2、pc | h5-v2/src/api/user.js<br>h5-v2/src/store/modules/user.js<br>h5-v2/src/views/chat/chat/child_modal/messageItem.vue<br>h5-v2/src/views/chat/chat/child_modal/userInfoBar.vue<br>h5-v2/src/views/chat/chat/game/setting.vue<br>h5-v2/src/views/grab-village/gaming-room/message/message-type/bettingType.vue<br>h5-v2/src/views/grab-village/gaming-room/message/message-type/emojiType.vue<br>h5-v2/src/views/grab-village/gaming-room/message/message-type/redPacketMessage.vue<br>...另 152 个路径见完整清单 |
| 接口/状态/工具 | 145 | h5-v2、pc | h5-v2/src/api/agent.js<br>h5-v2/src/api/app.js<br>h5-v2/src/api/betting.js<br>h5-v2/src/api/chat.js<br>h5-v2/src/api/cms.js<br>h5-v2/src/api/game.js<br>h5-v2/src/api/home.js<br>h5-v2/src/api/lottery.js<br>...另 137 个路径见完整清单 |
| 未归类路径 | 121 | h5-v2、pc、其他 | .gitignore<br>docs/merchant-frontend-branches.md<br>h5-v2/src/App.vue<br>h5-v2/src/components/Animal.vue<br>h5-v2/src/components/KeyboardInput/keyboard.vue<br>h5-v2/src/components/LanguageSwitch.vue<br>h5-v2/src/components/PwdInput/src/main.vue<br>h5-v2/src/components/Skeleton/Announce.vue<br>...另 113 个路径见完整清单 |
...
| 登录/注册/验证码 | 65 | h5-v2、pc | h5-v2/src/components/LoginNav/index.vue<br>h5-v2/src/utils/aliyunCaptcha.js<br>h5-v2/src/utils/authority-utils.js<br>h5-v2/src/utils/loginPasswordRule.js<br>h5-v2/src/views/login/diffPlaceLogin.vue<br>h5-v2/src/views/login/index.vue<br>h5-v2/src/views/login/login.vue<br>h5-v2/src/views/login/loginMixin.js<br>...另 57 个路径见完整清单 |
...
- 颜色值：#fff, #ffffff, #0000, #e4393c, #000000, #000, #333, #f3f3f3, #eee, #313131, #1f6efe, #999, #ddc17c, #eeeeee, #be1204, #ab47bc, #ff464b, #131522, #dddee1, #d2b79c, #ec0022, #3be6e5, #1f94ff, #f2f2f2, #5169de, #666, #222, #ff7614, #aa8743, #949494
...
| --- | --- | --- | --- | --- | --- |
| origin/BY-Demo-H5V2-PC | 1095 | 0 | 1097 | e01faf3edf3d | 2026-04-07 14:20:04 +0900 |
| origin/BY-Demo | 1323 | 0 | 1325 | e7bcc7ad0a61 | 2023-12-12 17:15:34 +0800 |
| origin/master | 4232 | 3 | 4238 | b7335bc10372 | 2020-08-03 10:12:19 +0800 |

## 最近商户分支提交

| 提交 | 日期 | 说明 |
| --- | --- | --- |
| ca31b2dc7 | 2026-06-19 | fix: remove auth text backgrounds on gold layout |
| 1b175ff80 | 2026-06-19 | fix: keep active tabs gradient fixed |
| 4cff9bfd7 | 2026-06-14 | fix: sync h5 theme variables |
| 1857efe2a | 2026-06-12 | fix: limit customer service picker to service links |
| 7f78f811e | 2026-05-29 | fix: use multUrl for customer service picker |
| 7d44ee02d | 2026-05-29 | feat: support multiple customer service urls |
| 9bf3fc758 | 2026-06-11 | fix: localize aliyun captcha trigger text |
| 3a6e560e5 | 2026-06-06 | fix: reset pc aliyun captcha lifecycle |
| 526fe1080 | 2026-06-05 | fix: align h5 sass loader config |
| 6b2d90b08 | 2026-06-05 | fix: handle aliyun captcha close in h5 requests |
| eb34e1607 | 2026-06-05 | fix: release aliyun captcha state after h5 close |
| 17dc02d3d | 2026-06-05 | fix: preserve aliyun captcha close lifecycle |
| 996059d74 | 2026-06-05 | fix: allow h5 aliyun captcha reopen after close |
| 2204b79df | 2026-06-05 | fix: stabilize h5 aliyun captcha touch handling |
| 13e42e38b | 2026-06-05 | fix: improve h5 aliyun captcha popup recovery |
| dbf2f8c86 | 2026-06-05 | fix: enforce aliyun captcha toggle fallback |
| 4138ecd0e | 2026-06-05 | fix: keep legacy sms flow when aliyun captcha is off |
| 1b0dc61f6 | 2026-06-04 | fix: align free play captcha flow with aliyun |
| 2764fa4cd | 2026-06-04 | fix: continue login after aliyun popup success |
| c51bb9ce3 | 2026-06-04 | fix: guard all auth captcha requests |
| d267c3d53 | 2026-06-04 | feat: replace yidun captcha with aliyun captcha |
| 539282e76 | 2026-06-04 | feat: enforce strong login password rules |
...
| M | h5-v2 | 构建配置 | 主题/颜色/静态资源、构建/配置 | 14 | 12 |  | h5-v2/public/configstatic/h5/control/control.js |
...
| M | h5-v2 | 组件 | 首页/导航/版面 | 16 | 12 |  | h5-v2/src/components/YiDun/index.vue |
...
| M | h5-v2 | 其他 | 未归类路径 | 42 | 8 |  | h5-v2/src/main.js |
| M | h5-v2 | 工具/混入 | 接口/状态/工具 | 20 | 6 |  | h5-v2/src/mixins/initGtCapthca.js |
...
| M | h5-v2 | 页面 | 登录/注册/验证码、首页/导航/版面 | 46 | 38 |  | h5-v2/src/views/password/indexNew.vue |
...
| M | h5-v2 | 页面 | 个人中心/账户、代理/报表/团队 | 21 | 15 |  | h5-v2/src/views/personal-center/child_modal/agency_center/userAdd.vue |
...
| M | h5-v2 | 页面 | 个人中心/账户 | 47 | 40 |  | h5-v2/src/views/personal-center/child_modal/mysetting/myPhone/myPhone.vue |
...
| M | h5-v2 | 页面 | 登录/注册/验证码、个人中心/账户 | 33 | 11 |  | h5-v2/src/views/personal-center/child_modal/mysetting/reset_login_pwd/reset_login_pwd.vue |
...
| M | h5-v2 | 页面 | 登录/注册/验证码、接口/状态/工具 | 56 | 11 |  | h5-v2/src/views/register/registerMixin.js |
...
| M | h5-v2 | 构建配置 | 构建/配置 | 43 | 40 |  | h5-v2/vue.config.js |
...
- 完整命令：`git diff --name-status --find-renames origin/BY-Demo-H5V2-PC...origin/BY8358-HP -- .`
- 有效端：`pc/`、`h5-v2/`
- 废弃端：`h5/`
