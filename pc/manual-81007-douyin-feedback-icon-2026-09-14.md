...
- 验证：使用 `C:\tools\node14\node.exe`（v14.21.3）执行 PC 生产构建；最新 v3 构建 chunk 包含 `yjfk` 资源且不包含旧反馈路径。2026-09-16 已随提交 `286514bfcd3d48c6c976b3e6ddecfceeb4edc978` 发布到 BY-Demo 演示站并加载新 PC 包；`81007`／抖音乐园线上站 `dw2024.com` 尚未单独发布，不能据此视为该商户线上已修复。
