# 商户分支功能地图：BY8320-857C

- 生成时间：2026-07-15 09:30:23 +0900
- 来源：远端分支 `origin/BY8320-857C`
- 分支提交：`de334c5f8` / 2026-06-21 20:17:31 +0900 / fix: keep blue-white promo tabs gradient
...
- 有效端差异文件：216 个；涉及功能域：首页/导航/版面、主题/颜色/静态资源、接口/状态/工具、登录/注册/验证码、未归类路径、个人中心/账户、构建/配置、彩票/投注/开奖。
...
| --- | --- | --- | --- | --- |
| pc | 201 | 48949 | 15226 | pc/.gitignore<br>pc/config/index.js<br>pc/configstatic/pc/control/control.js<br>pc/configstatic/pc/images/Icon-60.png<br>pc/configstatic/pc/images/favicon.ico<br>pc/configstatic/pc/images/ic_promotion_logo.png<br>pc/configstatic/pc/images/logo-icon.png<br>pc/configstatic/pc/images/logo.gif<br>...另 193 个路径见完整清单 |
...
| --- | --- | --- | --- | --- | --- |
| origin/BY-Demo-H5V2-PC | 216 | 0 | 218 | ac5ce626bae8 | 2024-01-25 14:52:34 +0800 |
| origin/BY-Demo | 351 | 0 | 353 | e7bcc7ad0a61 | 2023-12-12 17:15:34 +0800 |
...
| 提交 | 日期 | 说明 |
| --- | --- | --- |
| de334c5f8 | 2026-06-21 | fix: keep blue-white promo tabs gradient |
| 9d489af13 | 2026-06-11 | fix: localize aliyun captcha trigger text |
| 48505f068 | 2026-06-06 | fix: reset pc aliyun captcha lifecycle |
| 45bf309bd | 2026-06-05 | fix: handle aliyun captcha close in h5 requests |
| 9c0def9ac | 2026-06-05 | fix: release aliyun captcha state after h5 close |
| 2e4e84dbe | 2026-06-05 | fix: preserve aliyun captcha close lifecycle |
| 4d7c9fd0b | 2026-06-05 | fix: allow h5 aliyun captcha reopen after close |
| 286a34153 | 2026-06-05 | fix: stabilize h5 aliyun captcha touch handling |
| 52f4d4d1a | 2026-06-05 | fix: improve h5 aliyun captcha popup recovery |
| 36f2c8554 | 2026-06-05 | fix: enforce aliyun captcha toggle fallback |
| b6ac26a96 | 2026-06-05 | fix: keep legacy sms flow when aliyun captcha is off |
| 853a291c9 | 2026-06-04 | fix: align free play captcha flow with aliyun |
| 0eea40ebf | 2026-06-04 | fix: continue login after aliyun popup success |
| 27e4636b7 | 2026-06-04 | fix: guard all auth captcha requests |
| bc06b32e2 | 2026-06-04 | feat: replace yidun captcha with aliyun captcha |
| cd1da1169 | 2024-03-15 | 首页两侧对联 |
| fe9747dc5 | 2024-03-14 | 857彩 |
...
| M | pc | 页面 | 首页/导航/版面 | 107 | 131 |  | pc/src/views/layout/child_modal/FloatBanner.vue |
...
- 分支：`origin/BY8320-857C`
- 基准：`origin/BY-Demo-H5V2-PC`
- 完整命令：`git diff --name-status --find-renames origin/BY-Demo-H5V2-PC...origin/BY8320-857C -- .`
- 有效端：`pc/`、`h5-v2/`
- 废弃端：`h5/`
